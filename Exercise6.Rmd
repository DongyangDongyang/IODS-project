...
names(BPRS)
# column names are treatment", "subject", "week0", "week1", "week2", "week3", "week4", "week5", "week6", "week7", "week8".

# Look at the structure of BPRS
str(BPRS)
# Data set has 40 observations and 11 variables. Data type are all integer.

# Print out summaries of the variables
summary(BPRS)
# The minimum value, mean value, maximum value and quantile of variables can be checked out.
...
# The process of decrease of BPRS-score is fluctuating during the eight weeks. The men who have higher BPRS values at the beginning tend to have higher values throughout the study
```
...
dim(RATSL)
# The data has 176 observations and 5 variables.
...
# Compare to other groups, the weights of the rats in Group 1 are lower than others from the beginning to the end.
...
summary(RATS_reg)
# For one more week, the expected weights of rats in Group2 and Group3 are higher by 220.99 grams and 262.08 grams compared to Group1. The coefficient for "Time" is 0.5857, and the p-value associated with it is very small. There is a significant linear relationship between the passage of time and the weight of the rats.
```
